    ...
    <Card className="border-green-500 bg-green-50 dark:bg-green-950/20 dark:border-green-900 shadow-lg">
      <CardHeader className="pb-2">
        <div className="flex items-center">
          ...
          <CardTitle className="text-green-700 dark:text-green-300">Study Complete!</CardTitle>
        </div>
        <CardDescription>Thank you for chatting with both bots.</CardDescription>
      </CardHeader>
      <CardContent className="pb-2">
        <p className="text-sm">
          Please take a moment to complete our survey. Your feedback is valuable to our research.
        </p>
      </CardContent>
      <CardFooter>
        <a href={SURVEY_URL} target="_blank" rel="noopener noreferrer" className="w-full">
          <Button className="w-full bg-green-600 hover:bg-green-700">
            Take the Survey <ExternalLink className="ml-2 h-4 w-4" />
          </Button>
        </a>
      </CardFooter>
    </Card>
